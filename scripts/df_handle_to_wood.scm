(define (script-fu-df-handle-to-wood image drawables
                               source1
                               source2
                               source3
                               source4
...
(script-fu-register
	...
	SF-COLOR      "Source color 1"   "#E1CEAF"
	SF-COLOR      "Source color 2"   "#CDAC85"
	SF-COLOR      "Source color 3"   "#B98B5B"
	SF-COLOR      "Source color 4"   "#9E674A"
	SF-COLOR      "Source color 5"   "#775653"
	SF-COLOR      "Source color 6"   "#60474B"
	SF-COLOR      "Source color 7"   "#664B41"
	SF-COLOR      "Source color 8"   "#483743"
	
	SF-COLOR      "Target color 1"   "#D7D3D2"
	SF-COLOR      "Target color 2"   "#B3A59E"
	SF-COLOR      "Target color 3"   "#94877E"
	SF-COLOR      "Target color 4"   "#746A63"
	SF-COLOR      "Target color 5"   "#605852"
	SF-COLOR      "Target color 6"   "#564F49"
	SF-COLOR      "Target color 7"   "#4E4743"
	SF-COLOR      "Target color 8"   "#463E3D"
  )
  (script-fu-menu-register "script-fu-df-handle-to-wood" "<Image>/Colors/Map/Dwarf Fortress")
