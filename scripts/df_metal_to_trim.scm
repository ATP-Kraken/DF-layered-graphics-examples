(define (script-fu-df-metal-to-trim image drawables
                               source1
                               source2
                               source3
                               source4
...
(script-fu-register
    "script-fu-df-metal-to-trim"
    "Metal to Off-Palette"
	...
	SF-COLOR      "Source color 1"   "white"
	SF-COLOR      "Source color 2"   "#C7C4B4"
	SF-COLOR      "Source color 3"   "#A5A6A5"
	SF-COLOR      "Source color 4"   "#8A9091"
	SF-COLOR      "Source color 5"   "#6B7076"
	SF-COLOR      "Source color 6"   "#5A5E65"
	SF-COLOR      "Source color 7"   "#494C54"
	SF-COLOR      "Source color 8"   "#3C3E46"
	
	SF-COLOR      "Target color 1"   "#FFFEFF"
	SF-COLOR      "Target color 2"   "#CECAB9"
	SF-COLOR      "Target color 3"   "#A9AAA9"
	SF-COLOR      "Target color 4"   "#8B9293"
	SF-COLOR      "Target color 5"   "#696F75"
	SF-COLOR      "Target color 6"   "#565B62"
	SF-COLOR      "Target color 7"   "#464951"
	SF-COLOR      "Target color 8"   "#3F434C"
  )
  (script-fu-menu-register "script-fu-df-metal-to-trim" "<Image>/Colors/Map/Dwarf Fortress")
