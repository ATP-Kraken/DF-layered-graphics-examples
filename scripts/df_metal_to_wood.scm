(define (script-fu-df-metal-to-wood image drawables
                               source1
                               source2
                               source3
                               source4
...
(script-fu-register
  ...
  (script-fu-menu-register "script-fu-df-metal-to-wood" "<Image>/Colors/Map/Dwarf Fortress")
