(define (script-fu-df-wood-to-metal image drawables
                               source1
                               source2
                               source3
                               source4
...
(script-fu-register
  ...
  (script-fu-menu-register "script-fu-df-wood-to-metal" "<Image>/Colors/Map/Dwarf Fortress")
